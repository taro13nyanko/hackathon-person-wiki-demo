...
UNIV_OVERVIEWS = {
    ...
    "星環芸術大学": "映像、舞台、音楽、デザインを横断する芸術大学。",
    "白楓学院大学": "文学、教育、心理、情報文化を学ぶ人文系大学。",
    "港央医療大学": "医療、看護、健康情報を実践的に学ぶ大学。",
    "北辰国際大学": "言語と国際交流を中心に学ぶ大学。",
    "若葉社会大学": "経営、公共政策、地域活動を扱う社会科学系大学。",
    "光陵科学大学": "数理、地球環境、応用科学の研究を行う大学。",
}
...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .ff-symbol{display:inline-flex;align-items:center;gap:.12em;margin-right:.28em;vertical-align:-.08em;color:currentColor;}
  .ff-symbol i{display:block;width:0;height:0;border-top:.46em solid transparent;border-bottom:.46em solid transparent;border-left:.72em solid currentColor;}
  ...
  .ff-watermark{position:absolute;right:25px;bottom:18px;font-size:92px;color:rgba(255,255,255,.075);pointer-events:none;}
...
<div id="layout">
  <div id="sidebar">
    ...
    <button id="fastForwardFilterBtn" class="fast-forward-btn secondary" onclick="fastForwardActiveFilter()"><span class="ff-symbol" aria-hidden="true"><i></i><i></i></span>選択中を早送り</button>
    <div id="list"></div>
  </div>
...
<div id="ffConfigModal" class="ff-modal-backdrop hidden" role="dialog" aria-modal="true" aria-labelledby="ffConfigTitle">
  <div class="ff-config">
    <h2 id="ffConfigTitle"><span class="ff-symbol" aria-hidden="true"><i></i><i></i></span>早送りをつくる</h2>
...
function renderList(){
  ...
  if(ffBtn){
    ...
    ffBtn.innerHTML = usable ? `<span class="ff-symbol" aria-hidden="true"><i></i><i></i></span>${escapeHtml(targetCategory)}を早送り` : "";
...
function displayFastForwardDeck(){
  ...
  document.getElementById("article").innerHTML = `
    <div class="ff-shell">
      <div class="ff-topbar"><div><div class="ff-kicker"><span class="ff-symbol" aria-hidden="true"><i></i><i></i></span>TIME COMPRESSION</div><h1 style="margin:4px 0 0;">早送り</h1></div><button class="star-btn" onclick="history.back()">元のページへ戻る</button></div>
      <div id="ffStage" class="ff-stage" onclick="advanceFastForward()" title="クリックして次へ"><div id="ffSlideBody" class="ff-slide-body"></div><span class="ff-symbol ff-watermark" aria-hidden="true"><i></i><i></i></span></div>
...
function showArticle(id){
  ...
  document.getElementById("article").innerHTML = `
    ...
    <button class="fast-forward-btn" style="margin-left:6px;" onclick="openFastForwardConfig('person','${id.replace(/'/g,"\\'")}')"><span class="ff-symbol" aria-hidden="true"><i></i><i></i></span>${r.id === '神谷ハル' ? '自分の今までを早送り' : (isGroupRecord(r) ? 'このコミュニティを早送り' : 'この人との関係を早送り')}</button>
  ...
  document.getElementById("article").innerHTML = `
    <section class="home-hero">
      ...
      <div class="home-features">
        ...
        <div class="home-feature"><div class="home-feature-icon"><span class="ff-symbol" aria-hidden="true"><i></i><i></i></span></div><h3>時間を早送りする</h3><p>期間とグループを選ぶと、蓄積した記録をAIが3枚の物語にまとめます。</p></div>
      </div>
